...
describe("CurrencyExchange", () => {
  ...
  test("POST /currency-exchanges", async () => {
  ...
  test("GET /currency-exchanges", async () => {
    await request(app.getHttpServer())
  ...
  test("GET /currency-exchanges/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/currency-exchanges"}/${nonExistingId}`)
      .expect(404)
      .expect({
        statusCode: 404,
  ...
  test("GET /currency-exchanges/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/currency-exchanges"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
